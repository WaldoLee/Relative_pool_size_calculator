...
#############################################################################
# Input data
neg_source <- "C:/Users/biology/Desktop/LAB DB/Project_ing/Spatial fluxomics/1. Rapid fractionation/2 experiment/LCMS result/20170531_13C_gln_glc_WC_12C_fraction_relative_pool_size_neg/relative_pool_size.csv"
...
#############################################################################
write.xlsx(x = R_summary, file = "C:/Users/biology/Desktop/LAB DB/Project_ing/Spatial fluxomics/1. Rapid fractionation/2 experiment/LCMS result/20170531_13C_gln_glc_WC_12C_fraction_relative_pool_size_neg/relative_pool_size_neg.xlsx", sheetName = "R_summary", row.names = TRUE)
#############################################################################
...
#############################################################################
write.xlsx(x = WC_fraction, file = "C:/Users/biology/Desktop/LAB DB/Project_ing/Spatial fluxomics/1. Rapid fractionation/2 experiment/LCMS result/20170531_13C_gln_glc_WC_12C_fraction_relative_pool_size_neg/relative_pool_size_neg.xlsx", sheetName = "WC_fraction", row.names = TRUE, append=TRUE)
#############################################################################
